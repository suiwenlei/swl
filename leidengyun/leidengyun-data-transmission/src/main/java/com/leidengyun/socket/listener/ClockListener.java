...
import com.leidengyun.socket.task.clockTask;
...
public class ClockListener implements Runnable {
	...
	private static Logger logger = Logger.getLogger(ClockListener.class);
	...
	public void Listener() {
		while (this.listening) {
			try {
				...
				new Thread(new clockTask(socketPort, serverMap)).start();
			} catch (IOException ie) {
				ie.printStackTrace();
