...
<link type="images/x-icon" rel="shortcut icon"
	href="${_staticPath}/custom/assets/favicon.ico">
...
<!-- m97 styles -->
<link rel="stylesheet" href="${_staticPath}/M97/skin/WdatePicker.css" />
<script src="${_staticPath}/M97/WdatePicker.js"></script>
<script src="${_staticPath}/M97/lang/zh-cn.js"></script>
<script src="${_staticPath}/M97/calendar.js"></script>
<script src="${_staticPath}/M97/skin/default/datepicker.css"></script>


<!-- 自定义样式，表单多选框 -->
<link rel="stylesheet"
	href="${_staticPath}/custom/assets/ace.custom.css" />
		...
		<div class="navbar-container" id="navbar-container">
			...
			<div class="navbar-header pull-left">
				...
				<a href="#" class="navbar-brand"> <small> <i
						class="fa fa-leaf"></i> ${_systemAdminName}
				</small>
				</a>
...
<!-- 					</div> -->
					...
					<div class="ace-settings-container" id="ace-settings-container">
						...
						<div class="ace-settings-box clearfix" id="ace-settings-box">
							<div class="pull-left width-50">
								...
								<div class="ace-settings-item">
									<input type="checkbox" class="ace ace-checkbox-2" checked="checked"
							...
							<div class="pull-left width-50">
								...
								<div class="ace-settings-item">
									<input type="checkbox" class="ace ace-checkbox-2" checked="checked"
										...
										for="ace-settings-breadcrumbs"> 固定非内容</label>
								</div>
								...
								<div class="ace-settings-item">
									<input type="checkbox" class="ace ace-checkbox-2" checked="checked"
										...
										for="ace-settings-add-container"> 容器显示内容 </label>
								</div>
								...
								<div class="ace-settings-item">
									<input type="checkbox" class="ace ace-checkbox-2" checked="checked"
										...
										for="ace-settings-highlight"> 菜单样式</label>
								</div>
	...
	<!-- 修改默认首页 -->
	<script id="_ace" src="${_staticPath}/custom/assets/ace.js?v"
		data-path="${defaultPage}"></script>
	<!-- 切换菜单处理 -->
	<script id="_ajaxContent"
		src="${_staticPath}/custom/assets/ace.ajax-content.js?v"
		data-path="${_path}"></script>
	<!-- 权限处理 -->
	<script id="_permission"
		src="${_staticPath}/custom/jquery.permission.min.js?v"
	...
	<script
		src="${_staticPath}/assets/js/ace/ace.searchbox-autocomplete.js"></script>
	<script type="text/javascript">
			jQuery(function ($) {
				...
				$.getJSON("${_path}/index/menu?v=" + Math.random(), function(d) {
						...
						if (data.parentId == null || data.parentId == "") {
							...
							if(defaultPage == null && data.url){
								if(window.location.href.indexOf("#") < 0){
									...
									window.location.href = "${_path}/index#" + defaultPage;
