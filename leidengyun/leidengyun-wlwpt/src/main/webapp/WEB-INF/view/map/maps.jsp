...
<html style="height: 100%">
   ...
   <body style="height: 100%; margin: 0">
       ...
       <script type="text/javascript">
       	   ...
       	   var GsonDatas=eval("(" +GsonData+ ")");
       	   
       	 var GsonTip='${GsonTips}';
     	   var GsonTips=eval("(" +GsonTip+ ")");
       	   
       	
    	   var dom = document.getElementById("container");
   			var myChartCity = echarts.init(dom);
                   var ciytData = GsonDatas;           
                   var geoCoordMap = {
               		    '海门':[121.15,31.89],
        		...
        		//         }
                       ...
                       tooltip : {
                           ...
                           formatter:function(p){
                               ...
                               var obj=jsonOne[a];                            
                               var text = p.name+"</br>"
                               +"设备总数：<span style='color:#f0921e'>"+obj.presentSum+"</span></br>"                              
                               +"设备编号：</br>";
                               var dev=obj.presentDevId;
               
                               var devObj=dev.split(",");
                               for(var i=0;i<devObj.length;i++){
                            	   text+="<span style='color:#f0921e'>"+devObj[i]+"</span></br>";
                               }
