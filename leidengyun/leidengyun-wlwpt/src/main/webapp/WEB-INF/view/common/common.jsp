...
<script type="text/javascript">
	var scripts = [
		...
		// 列表
		"${_staticPath}/custom/jquery.table.min.js",
		// 时间
		...
		//时间控件
// 		"${_staticPath}/M97/WdatePicker.js",
// 		"${_staticPath}/M97/skin/WdatePicker.css",
// 		"${_staticPath}/M97/lang/zh-cn.js",
// 		"${_staticPath}/M97/calendar.js",
// 		"${_staticPath}/M97/skin/default/datepicker.css"
	];
</script>