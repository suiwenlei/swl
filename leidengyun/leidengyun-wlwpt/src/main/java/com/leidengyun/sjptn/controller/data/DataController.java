...
public class DataController extends BaseController {
	...
	public String execute(@ApiParam(value = "devId") Integer devId, Model model) {
		...
		String gsonTitle = devDataService.gsonDataTitle(devId,"","");
	...
	public @ResponseBody Result list(
		...
		Pagination<DevDataApp> page = devDataAppService.findPaginationByDevId(devId,qsrq,zzrq,new Pagination<DevDataApp>(pageNo, pageSize));
