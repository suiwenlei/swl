package com.leidengyun.sso.client;

import com.leidengyun.mvc.exception.ServiceException;
import com.leidengyun.sso.rpc.RpcUser;
...
public class SsoFilter extends ClientFilter {
	...
	private void redirectLogin(HttpServletRequest request, HttpServletResponse response) throws IOException {
		if (isAjaxRequest(request)) {
			...
			client.setParameter("backUrl", request.getRequestURL().toString());
			client.setParameter("appCode", ssoAppCode);
			client.sendByPost(ssoServerUrl+"/page");
